...
class _DogCardState extends State<DogCard> {
  ...
  Widget get dogCard {
    return new Positioned(
      ...
      child: new Container(
        ...
        height: 115,
        child: new Card(
          color: Color.fromRGBO(62, 62, 62, 1), //Cambiar color del container
          child: new Padding(
            ...
            child: new Column(
              ...
              children: <Widget>[
                ...
                new Row(
                  children: <Widget>[
                    new Icon(Icons.favorite_border), //Cambiar icono de estrella
  ...
  //Cambiar la puntuacion se queda permanentemente
